...
\begin{frame}{\todo{A concrete program with state transition system}}
  
\end{frame}

\begin{frame}{\todo{Consider the sets of states, collecting semantics \& reachable states}}
  
\end{frame}

\begin{frame}{\todo{Form a lattice from the sets of states, then start abstracting them}}
...
\begin{frame}{Iterative reductions\footcite{cousot2011reduced}}
  \small
  \todo{Represent this pictorially}
  \begin{itemize}[<+->]
