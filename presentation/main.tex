...
\end{lstlisting}
    ...
    \multiinclude[<+>][start=1,format=pdf,graphics={height=0.9\textheight}]{fig/adhoc-lattice}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{A plethora of domains}
  ...
  \end{tightcenter}
  \begin{itemize}
  \item<3-> Also: congruences, floating-point versions\footcite{mine2004relational}, \alt<5>{\emph{arithmetic-geometric progressions}}{arithmetic-geometric progressions}\footcite{feret2005arithmetic} \ldots{}
