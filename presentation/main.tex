...
\begin{frame}{Dynamic state partitioning for automata\footcite{jeannet_dynamic_1999}}
  \begin{columns}
    ...
    \begin{column}{0.3\textwidth}
      ...
      \only<handout>{\includegraphics[height=0.3\textheight]{fig/state-partitioning-2.pdf}}
...
\begin{frame}{Other methods for partitioning the state}
  \begin{itemize}[<+->]
  \item Partitioning transfer functions of programs with Booleans and integers by representing the functions as a MTBDD\footcite{jeannet_representing_2002}
