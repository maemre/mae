...
\begin{frame}{Dynamic state partitioning for automata\footcite{jeannet_dynamic_1999}}
  ...
  \begin{itemize}[<+->]
  \item Jeannet et al. propose a technique to partition state space of an automaton with polyhedral constraints as guards
...
\begin{frame}{A plethora of domains}
  ...
  \end{tightcenter}
  \begin{itemize}
  \item<4-> Also: congruences, floating-point versions\footcite{mine2004relational}, \alt<5>{\emph{arithmetic-geometric progressions}}{arithmetic-geometric progressions}\footcite{feret2005arithmetic} \ldots{}
